export default function DocsPage() {
  return (
    <div className="min-h-screen bg-[#070913] text-white p-20 flex flex-col items-center justify-center text-center gap-4">
      <h1 className="text-4xl font-bold font-heading">Developer Documentation</h1>
      <p className="text-gray-400 max-w-md">Phase 9 Polish: Fumadocs integration scaffolded. Full API references for /api/chat and n8n webhook schemas will reside here.</p>
